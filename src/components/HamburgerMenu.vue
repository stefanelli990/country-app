<template>
    <div :class="{ 'translate-x-0': countriesStore.menuIsVisible}" class="bg-white flex justify-between flex-col p-8 h-full w-64 fixed top-0 left-0 z-20 -translate-x-full duration-200 md:hidden dark:bg-slate-800">
        <div class="space-y-4">
